...
{
    private $vnp_TmnCode = "M3GKCM8S"; //Mã website tại VNPAY
    private $vnp_HashSecret = "ZBZFPLWZMMHLEWDIZCNAMIRHHQJQSBJE"; //Chuỗi bí mật
    private $vnp_Url = "http://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
    private $vnp_Returnurl = 'http://thinhbansach.local/shopping/hook';
