            ...
            <div class="box-title">
                <form class="form-inline">
                    ...
                    <select name="sort" class="form-control">
                        <option value="latest" {{ Request::get('sort') == 'latest' ? 'selected' : '' }}>Mới nhất</option>
                        <option value="oldest" {{ Request::get('sort') == 'oldest' ? 'selected' : '' }}>Cũ nhất</option>
                        <option value="asc" {{ Request::get('sort') == 'asc' ? 'selected' : '' }}>Số lượng tăng dần</option>
                        <option value="desc" {{ Request::get('sort') == 'desc' ? 'selected' : '' }}>Số lượng giảm dần</option>
                    </select>
